/* GssParserCC.java */
/* Generated by: ParserGeneratorCC: Do not edit this line. GssParserCC.java */
...
// Supports rule
// https://developer.mozilla.org/en-US/docs/Web/CSS/@supports#supports-condition
  final public CssValueNode supportsInParens() throws ParseException {CssNode v;
  SourceCodeLocation beginLocation;
  Token t;
  String value = "";
  List<Token> tokens = Lists.newArrayList();
  List<Token> mediaTokens = null;
beginLocation = this.getLocation(token.next);
...
value += v.toString();
      ...
      switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
      case IDENTIFIER:{
        mediaTokens = parseMediaTokens();
StringBuilder sb = new StringBuilder();
    for (Token token : mediaTokens) {
      sb.append(token.image);
    }
    value += sb.toString();
    tokens.addAll(mediaTokens);
        break;
        }
      default:
        jj_la1[60] = jj_gen;
    ...
    t = jj_consume_token(RIGHTROUND);
tokens.add(t); value += ")";
{if ("" != null) return nodeBuilder.buildLiteralNode(value,
      this.mergeLocations(beginLocation, this.getLocation()), tokens);}
    throw new IllegalStateException ("Missing return statement in function");
}

  final public CssValueNode supportsCondition() throws ParseException {CssValueNode value;
  List<CssValueNode> lst = Lists.newArrayList();
  SourceCodeLocation beginLocation;
  Token t;
  List<Token> tokens = Lists.newArrayList();
beginLocation = this.getLocation(token.next);
    ...
    case IDENTIFIER:{
      // not
            t = jj_consume_token(IDENTIFIER);
lst.add(new CssLiteralNode(t.image, this.getLocation(t)));
      label_42:
      while (true) {
        jj_consume_token(S);
        switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
if (lst.size() == 1) {
      ...
      {if ("" != null) return nodeBuilder.buildCompositeValueNode(lst, CssCompositeValueNode.Operator.SPACE,
        this.mergeLocations(beginLocation, this.getLocation()), tokens);}
    }
    throw new IllegalStateException ("Missing return statement in function");
}
...
//   ;
  ...
  CssStringNode stringNode = null;
  List<Token> tokens = Lists.newArrayList();
  List<Token> mediaTokens = Lists.newArrayList();
...
// tokens stream suitable for media and support queries
  final public List<Token> parseMediaTokens() throws ParseException {Token dim = null;
  Token t = null;
  List<Token> tokens = Lists.newArrayList();
    t = jj_consume_token(IDENTIFIER);
tokens.add(t);
...
// unit
//  : [ var | calc | IDENTIFIER | NUMBER | DIMENSION | PERCENTAGE | "(" S* sum S* ")" ];
//  ;
...
// (non-standard GSS extension)
// at_supports
//   : ATSUPPORTS S* [ [ composite_term | extended_term ] S* ]*
//     [ [ '{' S* block  '}'  ] | ';' ] S*
//   ;
  final public CssAtRuleNode at_supports() throws ParseException {Token t;
  SourceCodeLocation beginLocation = null;
  CssLiteralNode name;
  CssValueNode v;
  CssBlockNode block = null;
  ...
  List<Token> tokens = Lists.newArrayList();
    try {
      t = jj_consume_token(ATSUPPORTS);
beginLocation = this.getLocation(t);
      name = new CssLiteralNode("supports", beginLocation);
      tokens.add(t);
      label_81:
      while (true) {
        switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
...
result.append("(");
 ...
 {
    if (jj_scan_token(ATSUPPORTS)) return true;
    return false;
  }
  ...
  private boolean jj_3R_123()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x8000,0x0,0x0,0x8020000,0x8020000,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x8,0x80,0x0,0x80,0x0,0x0,0x100,0x0,0x0,0x0,0x100,0x218,0x218,0x218,0x218,0x238,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x4,0x0,0x20,0x0,0x20,0x4,0x20,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x8000,0x0,0x100,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x800,0x0,0x80,0x20000,0x20000,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x80000000,0x0,0x10000,0x40000000,0x0,0x10000,0x0,0x800,0x0,0x0,0x80,0x0,0x0,0x0,0x8000,0x18,0x0,0x18,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x60,0x0,0x0,0x0,0x60,0x80,0x20000,0x20000,0x80,0x0,0x0,0x880,0x0,0x0,0x0,0x0,0x0,0x0,0x2004,0x0,0x0,0x2004,0x0,0x0,0x0,0x0,0x0,0x0,0x2004,0x0,0x0,0x0,0x0,0x0,0x0,0x2004,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x0,0x0,0x238,0x238,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x4,0x0,0x2a00,0x2a00,0x0,0x2a00,0x2a00,0x0,0x2a00,0x2a00,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x60000000,0x0,0x2000,0x2000,0x0,0x0,0x2000,0x2000,0x2000,0x2000,0x2000,0x2000,0x0,0x0,0x4030000,0x2000,0x4030000,0x2000,0x2000,0x1f,0x2000,0x60000000,0x2000,0x1f,0x8000000,0x8000000,0x8000000,0x8000000,0x8000000,0x0,0x2000,0x2000,0x2000,0x2000,0x2000,0x1e2000,0x2000,0x0,0x2000,0x0,0x2000,0x0,0x2000,0x0,0x0,0x0,0x2000,0x2000,0x0,0x2000,0x2000,0x2000,0x10000000,0x0,0x2000,0x0,0x2000,0x0,0x2000,0x2000,0x0,0x2000,0x2000,0x2000,0x0,0x2000,0x20000,0x0,0x0,0x2000,0x64020000,0x0,0x8000000,0x2000,0x2000,0x2000,0x2000,0x2000,0x0,0x4000000,0x2000,0x0,0x2000,0x0,0x0,0x2000,0x0,0x2000,0x0,0x2000,0x2000,0x20000,0x2000,0x2000,0x2000,0x0,0x0,0x0,0x0,0x0,0x2000,0x2000,0x2000,0x30000,0x2000,0x30000,0x2000,0x2000,0x2000,0x2000,0x0,0x20000,0x0,0x0,0x4020000,0x2000,0x2000,0x4020000,0x2000,0x2000,0x2000,0x2000,0x2000,0x2000,0x0,0x2000,0x2000,0x0,0x2000,0x0,0x2000,0x2000,0x0,0x2000,0x0,0x2000,0x0,0x2000,0x2000,0x0,0x2000,0x0,0x2000,0x2000,0x2000,0x4000000,0x2000,0x0,0x2000,0x4000000,0x2000,0x8000000,0x8000000,0x0,0x2060,0x2060,0x2060,0x2060,0x2000,0x0,0x0,0x2000,0x0,0x0,0x2000,0x0,0x0,0x2000,0x0,0x0,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x434,0x434,0x6,0x0,0x6,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc,0x0,0x8000,0x0,0xc,0x0,0xc,0x8000,0xc,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x0,0x0,0x4,0x4,0x0,0x200,0x2,0x4c4,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x404,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0xc4,0x0,0x0,0xc4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x400,0x0,0x0,0x0,0x4,0x0,0x0,0x400,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x0,0xf804,0x4,0xe000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
   ...
   */
  public GssParserCC(final CharStream stream) {
   ...
   */
  public GssParserCC(final GssParserCCTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
   ...
   * @param tm Token manager to use
   */
  public void ReInit(final GssParserCCTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
