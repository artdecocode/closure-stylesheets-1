...
- Target _Java 1.8_.
- Merge in [`--allow-duplicate-declarations`](https://github.com/google/closure-stylesheets/commit/802338e1de297a62f32241f33f8fc9f4e60e530b) feature, but also [properly preserve]() duplicate declarations rather than keeping the last one.
...
- Allow to skip html escaping of strings in values with `--skip-html-escaping`.
